	...
	return (
		<section className="w-full p-6 bg-orange-50 font-sans flex items-center justify-center" id="kontakt">
			<motion.div
				...
				viewport={{ once: true }}
				className="max-w-4xl w-full bg-orange-50 p-2 rounded-xl">
				{/* Nagłówek */}
				<motion.h2 variants={fadeInUp} className="text-5xl font-bold text-purple-900 mb-4 text-center">
					Kontakt
				</motion.h2>
				<motion.p variants={fadeInUp} className="text-xl text-gray-700 mb-8 text-center">
				...
				<motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
					...
					<motion.div variants={fadeInUp} className="bg-gradient-to-br from-orange-100 to-purple-100 p-6 rounded-lg">
					...
					<motion.div variants={fadeInUp} className="bg-gradient-to-br from-orange-100 to-purple-100 p-6 rounded-lg">
						...
						<div className="overflow-hidden rounded-lg">
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d20521.23582015488!2d20.5979302!3d49.989713200000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spl!2spl!4v1737730022963!5m2!1spl!2spl"
								width="600"
								height="450"
								style={{border: 0}}
								loading="lazy"
