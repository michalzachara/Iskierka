...
const Iskierka = () => {
  ...
  const images = [
    '/header/2147760563 (2).jpg', // Upewnij się, że ścieżki są poprawne
    '/header/example1.jpg',
    '/header/example2.jpg',
  ];

  return (
    <section className="w-full mx-auto p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl shadow-lg font-sans" id='iskierka'>
      {/* Nagłówek */}
      <motion.h1
        initial="hidden"
        whileInView="visible"
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center xl:ml-[30%] xl:mr-[30%]">
        ...
        <div className="text-center animate-fadeIn delay-800 mt-10 mb-10">
